...
import { Search, Star, Trash2, Edit2, Plus, Users, Loader2 } from 'lucide-react'
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
export default function BusinessContactsPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div>
        <Link href="/business/wallet" className="text-sm text-muted-foreground hover:text-foreground">
